...
assert engine.previous_engine.state == VMState.HALT \
    and engine.previous_engine.result_stack.peek() == IntegerStackItem(0)
# The following codes require wallet support from neo-mamba
engine.invoke_method_of_arbitrary_contract(neo.hash, 'transfer', [neo.hash, contract_owner_hash, 100, b'data'])
